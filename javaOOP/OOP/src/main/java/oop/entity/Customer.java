...
public class Customer extends Person {
	...
	public Customer(Person p, String address, Company company) {
		super(p);
	...
	public Customer(String name, String surname, int age, char gender, String identificationNumber, String address, Company company) {
